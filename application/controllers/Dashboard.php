...
class Dashboard extends CI_Controller 
{
	...
	public function __construct()
	{
		...
		$data['page_url'] = site_url('dashboard');
	...
	public function index()
	{
		...
		$this->add_js('themes/sb-admin/vendor/datatables/jquery.dataTables.js');
		$this->add_js('themes/sb-admin/vendor/datatables/jquery.dataTables.js');
		$this->add_js('themes/sb-admin/vendor/chart.js/Chart.min.js');
		
		$this->add_js('themes/sb-admin/js/sb-admin-charts.min.js');
		$this->add_js('themes/sb-admin/js/sb-admin-datatables.min.js');
